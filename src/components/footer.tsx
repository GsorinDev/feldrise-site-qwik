	...
	return (
		<footer class="w-full max-w-desktop px-8 py-12 flex flex-col md:flex-row gap-4 justify-center md:justify-between items-center">
			<span class="text-xl text-center md:text-left">
				Copyright © {new Date().getFullYear()} <span class='text-primary'>Feldrise</span> -
				Made with <a class="text-secondary" href="https://qwik.builder.io/" target='_blank' rel="norefferer">Qwik</a>
				-
			...
			<div class="flex gap-4">
				<a href="https://fr.linkedin.com/in/feldrise" target="_blank" rel="noreferrer">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2a2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></g></svg>
				</a>
				...
				<a href={`mailto:contact@feldrise.com?subject=Demande de contact depuis le site`} target="_blank" rel="noreferrer">
					{/* eslint-disable-next-line max-len */}
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7l-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></g></svg>
				</a>
			</div>
		</footer>
	);
